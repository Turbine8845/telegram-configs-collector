...
# url = 'https://raw.githubusercontent.com/Turbine8845/telegram-proxies-collector/main/telegram channels.json'
...
for url_link in subscription_links:
    try:
        ...
        if 'Turbine8845' not in url_link:
            raw_array_links_content.append((url_link, links_content))
        elif 'Turbine8845' in url_link and 'channels' in url_link:
...
dev_sign = "\U0001F468\U0001F3FB\u200D\U0001F4BB DEVELOPED-BY Turbine8845 \U0001F4CC"
